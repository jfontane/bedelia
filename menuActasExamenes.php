  ...
  <article class="img form">
    <div class="jumbotron jumbotron-fluid rounded form2">
      <div class="container justifu+y-content-center">
        <h2 class="display-5">Actas de Exámenes</h2>
        <hr>
    <form id="form">
      ...
      <div class="form-row">  
        <div class="form-group col-md-6">
          ...
          <select name="selectCarreras" id="selectCarreras"  class="form-control" onchange="cargaMateriasConInscriptosPorCarrera(this.value)">
...
$(function () {
    ...
    if (turno.habilitado=='Si') {
       ...
       if (turno.cantidad_llamados==1) {
         $('#selectLlamado').append("<option value='"+turno.calendario_id_inscripcion_asociada+"_1' >1er Llamado</option>");
       } else if (turno.cantidad_llamados==2) {
         $('#selectLlamado').append("<option value='"+turno.calendario_id_inscripcion_asociada+"_1' >1er Llamado</option>");
         $('#selectLlamado').append("<option value='"+turno.calendario_id_inscripcion_asociada+"_2' >2do Llamado</option>");
       };
...
function cargaMateriasConInscriptosPorCarrera(val)
    {
