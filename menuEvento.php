...
function load(page) {
    ...
    //   let busqueda = $("#inputBusquedaRapida").val();
      let per_page = 2;
      let parametros = {"action": "listar","page": page,"per_page": per_page, "coddigo": codigo, "descripcion": descripcion};
      let titulo = "<h1><i><u>"+ entidad_titulo2 +" </u></i></h1><h2>Listado</h2>";
      $("#titulo").html(titulo);
      $.ajax({
